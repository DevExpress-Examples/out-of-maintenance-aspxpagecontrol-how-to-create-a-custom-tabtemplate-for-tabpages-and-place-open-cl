...
<head runat="server">
    <title>ASPxPageControl: How to Create a Custom TabTemplate for TabPages and Place Open/Close Buttons inside the Template and Add Functionality to These Buttons Using ASPxCallbackPanel Callback Event (TabPages are Recreated after Each Callback and after Each TabPage is Added)</title>
